...
_G.packer_plugins = {
  ...
  everforest = {
    loaded = true,
    path = "/Users/macbook/.local/share/nvim/site/pack/packer/start/everforest",
  ...
  ["mellow.nvim"] = {
    loaded = true,
    path = "/Users/macbook/.local/share/nvim/site/pack/packer/start/mellow.nvim",
    url = "https://github.com/kvrohit/mellow.nvim"
  },
  ["mini.nvim"] = {
    loaded = true,
    path = "/Users/macbook/.local/share/nvim/site/pack/packer/start/mini.nvim",
  ...
  neovim = {
    loaded = true,
    path = "/Users/macbook/.local/share/nvim/site/pack/packer/start/neovim",
  ...
  ["nvim-tundra"] = {
    loaded = true,
    path = "/Users/macbook/.local/share/nvim/site/pack/packer/start/nvim-tundra",
  ...
  ["todo-comments.nvim"] = {
    loaded = true,
    path = "/Users/macbook/.local/share/nvim/site/pack/packer/start/todo-comments.nvim",
